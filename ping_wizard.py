...
# Another way to execute this is the script: curl -sLo /tmp/ping_wizard.py https://raw.githubusercontent.com/edino/PingWizard/main/ping_wizard.py && python3 /tmp/ping_wizard.py
